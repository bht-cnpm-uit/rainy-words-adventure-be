...
var getListTopic = /*#__PURE__*/function () {
...
var mergeObjects = function mergeObjects(arr) {
  var map = new Map();
  arr.forEach(function (obj) {
    var topicEn = normalizeString(obj.nameEn);
    var topicVn = normalizeString(obj.nameVi);
    if (map.has(topicEn)) {
      var existingObj = map.get(topicEn);
...
var removeDuplicates = function removeDuplicates(arr1, arr2) {
  return arr1.filter(function (obj1) {
    return !arr2.some(function (obj2) {
      return obj1.nameEn === obj2.nameEn && obj1.nameVi === obj2.nameVi;
    });
  });
};
var createTopic = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(listTopic) {
        ...
        case 0:
          return _context4.abrupt("return", new Promise( /*#__PURE__*/function () {
            var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(resolve, reject) {
              var currentListTopic, normalizeTopics, removeDuplicateTopics;
              return _regeneratorRuntime().wrap(function _callee3$(_context3) {
                while (1) switch (_context3.prev = _context3.next) {
                  ...
                  case 3:
                    currentListTopic = _context3.sent;
                    ...
                    //   });
                    // }
                    normalizeTopics = mergeObjects(listTopic);
                    removeDuplicateTopics = removeDuplicates(normalizeTopics, currentListTopic);
                    if (!(removeDuplicateTopics.length > 0)) {
                      _context3.next = 9;
                      break;
                    }
                    _context3.next = 9;
                    return _index["default"].Topic.bulkCreate(removeDuplicateTopics, {})["catch"](function (err) {
                      console.log(err);
                    });
                  case 9:
...
var deleteTopic = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(topicId) {
              ...
              return _regeneratorRuntime().wrap(function _callee5$(_context5) {
                while (1) switch (_context5.prev = _context5.next) {
                  case 0:
                    _context5.prev = 0;
                    _context5.next = 3;
                    return _index["default"].Word.destroy({
                      where: {
                        topicId: topicId
                      }
                    })["catch"](function (err) {
                  ...
                  case 3:
                    _context5.next = 5;
                    return _index["default"].Topic.destroy({
                      where: {
                        id: topicId
                      }
                    })["catch"](function (err) {
                  ...
                  case 5:
                    return _context5.abrupt("return", resolve({
                      errCode: 0,
                      message: "Delete topic ".concat(topicId, " successfully!")
                    }));
                  case 8:
                    _context5.prev = 8;
...
var updateTopic = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(topicId, nameEn, nameVi) {
              ...
              return _regeneratorRuntime().wrap(function _callee7$(_context7) {
                while (1) switch (_context7.prev = _context7.next) {
                  case 0:
                    _context7.prev = 0;
                    _context7.next = 3;
                    return _index["default"].Topic.update({
                      nameEn: nameEn,
                      nameVi: nameVi
                    }, {
                      where: {
                      ...
                      resolve({
                        errCode: 0,
                        message: "Update topic ".concat(topicId, " unsuccessfully!")
                      });
                    });
                  case 3:
                    resolve({
                      errCode: 0,
                      message: "Update topic ".concat(topicId, " successfully!")
                    });
                    _context7.next = 9;
                    break;
                  case 6:
  ...
  return function updateTopic(_x9, _x10, _x11) {
